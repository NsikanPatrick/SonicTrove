...
# Connection to the local postgresql database has been made in the config.py file
#----------------------------------------------------------------------------#
# Models.
...
# implemented search on artists with partial string search. Ensuring it is case-insensitive."
...
def create_venue_submission():
    ...
    try:
        ...
        # On unsuccessful db insertion, an error message is flashed.
